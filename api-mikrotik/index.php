...
<body>
    <div class="container">
        ...
        <div id="viewIp" class="tabcontent" style="display:none;">
            ...
            <form action="view_ip.php" method="post">
                <label for="current_ip"><center>Si deseas editar una Direccion Ip o Interfaz selecciona "Editar" en la Ip que deseas hacer cambios.</center></label>
            ...
            <div id="bandwidthControl" class="tabcontent" style="display:none;">
                ...
                <form action="set_bandwidth.php" method="post">
                    ...
                    <select id="download_limit" name="download_limit" required>
                    ...
                    <select id="upload_limit" name="upload_limit" required>
                        <option value="64K">64K</option>
                        <option value="128K">128K</option>
                        <option value="256K">256K</option>
                        <option value="384K">384K</option>
    ...
    <script>
        ...
        // Oculta la lista de IPs si se seleccionan las pestañas de "Agregar Usuario" o "Ver Usuarios"
        if (tabName === 'addUser' || tabName === 'viewUsers') {
            document.getElementById('ipList').style.display = "none"; // Oculta la lista
        } else {
            document.getElementById('ipList').style.display = "block"; // Muestra la lista en otras pestañas
        }
